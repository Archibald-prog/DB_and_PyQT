...
import select
import sys
from lesson_4.config import ACTION, PRESENCE, TIME, RESPONSE, OK, WRONG_REQUEST, \
...
from lesson_4.logs import server_config_log
from lesson_4.descriptors import SockVerify
from lesson_4.meta import ServerVerifier
